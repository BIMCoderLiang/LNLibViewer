...
#define NC_HAS_SZIP       /*!< szip support */
#define NC_HAS_SZIP_WRITE  /*!< szip write support */
#define NC_HAS_DAP2      0 /*!< DAP2 support. */
#define NC_HAS_DAP4      0 /*!< DAP4 support. */
#define NC_HAS_BYTERANGE  /*!< Byterange support. */
...
#define NC_HAS_NCZARR         /*!< Parallel I/O with filter support. */
#define NC_HAS_MULTIFILTERS   /*!< Nczarr support. */
#define NC_HAS_LOGGING       0 /*!< Logging support. */
#define NC_HAS_QUANTIZE       /*!< Quantization support. */
#define NC_HAS_ZSTD           /*!< Zstd support. */
#define NC_HAS_BENCHMARKS     /*!< Benchmarks. */
#define NC_HAS_S3             /*!< Amazon S3 Support. */
#define NC_HAS_BLOSC          /*!< Blosc Support. */
#define NC_HAS_BZ2            /*!< bzip2 support */
